...
namespace SeaExpenBackend.Controllers
{
    ...
    {
        private SeaExpenContext _context;
        public UserController(SeaExpenContext context) { _context = context; }
        ...
        public IActionResult Post([FromBody] UserModel model)
        {
            ...
            try
            {
                ...
                var i = _context.Database.ExecuteSql($"exec usp_Manage_User @Action=1, @Name={model.Name}, @Username={model.Username}, @Password={model.Password}, @Email={model.Email} , @Role=2");
